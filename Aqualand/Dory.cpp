...
*/
CDory::CDory(CAquarium* aquarium) : CItem(aquarium)
{
    mFishImage = unique_ptr<Bitmap>(Bitmap::FromFile(DoryImageName.c_str()));
 ...
 */
void CDory::Draw(Gdiplus::Graphics* graphics)
{
 ...
 * \return true if hit.
 */
bool CDory::HitTest(int x, int y)
{
    double wid = mFishImage->GetWidth();
    double hit = mFishImage->GetHeight();
